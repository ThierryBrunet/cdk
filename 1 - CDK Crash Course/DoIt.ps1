...
[4] CDKDay talk: Creating Verifiable JSON Web Tokens with AWS CDK https://www.youtube.com/watch?v=v9116...
...
[15] Cross-account CI/CD Pipeline with CDK Pipelines: https://catalog.us-east-1.prod.worksh... -- https://ap-southeast-2.console.aws.amazon.com/cloud9/home/product
...
Tutorial: Launch an EC2 Instance With AWS CDK - and connect to it
